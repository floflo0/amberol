...
impl Window {
                        ...
                        if songs.is_empty() {
                            ...
                            #[cfg(not(feature = "autoplay"))]
                            {
                                ...
                                if songs.len() == 1 {
                                    ...
                                    #[cfg(feature = "last_played_song")]
                                    if let Some(last_played_song) =
                                        win.imp().restoring_playlist.get()
                                    {
                            ...
                            #[cfg(feature = "autoplay")]
                            {
                                ...
                                if was_empty {
                                    player.play();
                                } else if player.state().get_playback_state()
    ...
    fn connect_signals(&self) {
        ...
        #[cfg(any(feature = "shortcuts", feature = "volume_shortcuts"))]
        {
            ...
            searchentry_focus_controller.connect_enter(clone!(
                #[weak(rename_to = win)]
                self,
                move |_| {
            ...
            searchentry_focus_controller.connect_leave(clone!(
                #[weak(rename_to = win)]
                self,
                move |_| {
